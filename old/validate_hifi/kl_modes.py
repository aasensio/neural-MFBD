...
class KL(object):
    ...
    def __init__(self):        
        ...
        self.cz = tmp[:,2]
        self.KL_variance = np.load('kl/KL_variance.npy')

    def precalculate(self, npix_image, n_modes_max, first_noll=1, overfill=1.0):
        """
...
if (__name__ == '__main__'):
    ...
    tmp.precalculate_covariance(npix_image=128, n_modes_max=25, first_noll=1)
